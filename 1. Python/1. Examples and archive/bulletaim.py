...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, start_x, start_y, dest_x, dest_y):
        ...
        velocity = 5
        self.change_x = math.cos(angle) * velocity #cosine for the change in x
        self.change_y = math.sin(angle) * velocity #sine for the change in y
...
while not done:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            bullet = Bullet(player.rect.x+5, player.rect.y+5, mouse_x, mouse_y)
